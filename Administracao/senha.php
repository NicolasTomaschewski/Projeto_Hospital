                    ...
                    <?php
                        ...
                        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                            ...
                            if ($senha === $senha_confirmar) {
                                ...
                                // Certifique-se de que a variável $_SESSION['id_administrador'] esteja definida corretamente
                                if (isset($_SESSION['id_administrador'])) {
                                    $sql = "UPDATE Administradores SET senha = '$senha_criptografada' WHERE id_administrador = '$_SESSION[id_administrador]'";
