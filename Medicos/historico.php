        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Histórico de operações realizadas pelo médico</p>
...
$sql = "SELECT o.id_operacao, o.sala, o.data_agendamento, o.data_operacao, o.hora, 
        ...
        WHERE o.liberado = '1'"; // Filtrando registros com liberado = "1" (liberado)
...
if ($result->num_rows > 0) {
    ...
    echo "<tr><td colspan='8'>Nenhuma operação liberada.</td></tr>";
}
