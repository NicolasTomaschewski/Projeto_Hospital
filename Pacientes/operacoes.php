...
// Consulta para obter registros onde "liberado" seja "Não" para um paciente específico
$sql = "SELECT o.id_operacao, o.sala, o.data_agendamento, o.data_operacao, o.hora, 
        ...
        WHERE o.liberado = 'Não' AND p.id_paciente = '" . $_SESSION['id_paciente'] . "'"; // Filtrando registros com liberado = "Não" para o paciente logado
