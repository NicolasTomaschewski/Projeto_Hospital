                    ...
                    <?php
                        ...
                        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                            ...
                            if ($senha === $senha_confirmar) {
                                ...
                                // Certifique-se de que a variável $_SESSION['id_paciente'] esteja definida corretamente
                                if (isset($_SESSION['id_paciente'])) {
                                    $sql = "UPDATE Pacientes SET senha = '$senha_criptografada' WHERE id_paciente = '$_SESSION[id_paciente]'";
