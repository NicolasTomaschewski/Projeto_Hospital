...
$sql = "SELECT * FROM Pacientes WHERE id_paciente = '" . $_SESSION['id_paciente'] . "'";
$result = $conn->query($sql);

if ($result) {
    while ($row = $result->fetch_assoc()) {
        // Aqui verificamos se o CPF é igual à senha (conforme sua lógica)
        if (md5($row['cpf']) == $row['senha']) {  // Comparando CPF com a senha
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Altere a sua senha imediatamente! A senha deve ser diferente do seu CPF.
                    </div>
