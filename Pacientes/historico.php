...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Seus resultados</h1>
                    <p class="mb-4">Histórico de operações realizadas pelo paciente.</p>
    ...
    <tr>
        ...
        <th>Baixar Resultado</th>
                    ...
                    // Consulta para obter registros onde "liberado" seja "Sim" para um paciente específico
    ...
    WHERE o.liberado = 'Sim' AND p.id_paciente = '" . $_SESSION['id_paciente'] . "'";
            ...
            <td>
                <form action='gerar_pdf.php' method='POST' target='_blank'>
                    ...
                    <button type='submit' class='btn btn-primary'>Gerar PDF</button>
                        ...
                        echo "<tr><td colspan='9'>Nenhum resultado liberado.</td></tr>";
                    }
